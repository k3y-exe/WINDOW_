...
WINDOW_ is a minimal, C89-compatible, header-only library for creating windows on Windows, Linux (X11), and macOS (Cocoa). It provides a simple API to create, poll, and destroy windows with a clean naming convention: WINDOW_ namespace, PascalCase functions, camelCase struct members, and p_ prefix for parameters.
